...
seed=42
dataset_name="aokvqa" # coco | aokvqa | gqa
...
# instructblip
# model="instructblip"
# model_path='/restricted/projectnb/batmanlab/yhe2_/add_task/DeGF/data/ce/model/vicuna-7b-v1.1'
...
torchrun --nnodes=1 --nproc_per_node=1 --master_port 2235 eval_bench/base_pope_eval_${model}.py \
--seed ${seed} \
